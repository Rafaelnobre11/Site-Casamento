            ...
            fetch(`https://viacep.com.br/ws/${cep}/json/`)
                ...
                .then(data => {
                    if (!data.erro) {
                        ...
                        const gmapsEmbed = `https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}&q=${encodeURIComponent(`${address}, ${formState.addressNumber}`)}`;
